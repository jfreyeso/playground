...
const SessionBlankState = () => {
  ...
  return (
    <div className="mt-1 flex items-center justify-center rounded-lg bg-white pb-6 pt-4">
      <div className="flex flex-col items-center gap-1">
        <HistoryBlankStateIcon />
        <div className="flex flex-col items-center gap-2">
          <h3 className="text-sm font-medium text-black">No Session found</h3>
          <p className="text-primary max-w-[210px] text-center text-sm">
            {errorMessage}
          </p>
        </div>
      </div>
